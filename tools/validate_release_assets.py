...
CODE_MARKERS = (
    'from t5_base_text2text_pipeline import DECISION_RULE, DEFAULT_MAX_NEW_TOKENS, MAX_INPUT_TOKENS, '
    'MAX_NEW_TOKENS, MAX_NUM_BEAMS, MAX_TEXT_CHARS, TASK_PREFIXES',
    'from t5_base_text2text_pipeline import MODEL_ID, MODEL_KEY, MODEL_REVISION, '
    'T5BaseText2TextPipeline, stage_missing_files, verify_snapshot',
