"""Static release-asset validation for the T5-Base text-to-text DIMER pipeline.
...
EXPECTED_MODEL_ID = "google-t5/t5-base"
...
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/t5_base_text2text_train.csv",
    "outputs/t5_base_text2text_input_manifest.json",
    "outputs/t5_base_text2text_evaluation_report.json",
    "outputs/t5_base_text2text_generations.csv",
    "outputs/t5_base_text2text_adapter",
    "outputs/t5_base_text2text_result.json",
)
CODE_MARKERS = (
    # Stage 4: pinned corpus, validation, disjoint split, the prefix, CSV, refusal probes
    "USE_BYOD = False",
    "PREFIX = 'paper title: '",
    ...
    "'prefix_is_trained': known_prefix(PREFIX) is not None",
    "write_dataset_csv(train_records, 'outputs/t5_base_text2text_train.csv')",
    # Stage 5: the inference contract with its manifest, rejection probe, sanity checks and the new-prefix probe
    ...
    # Stage 6: Lead-1, the frozen model under the new prefix and under summarize:
    ...
    # Stage 9: new abstracts, single-item report, the trained prefix after adaptation, artifact, reload parity, provenance
...
MARKDOWN_MARKERS = (
    "**Capability:** caller-prefixed text-to-text generation",
    "and bounded supervised fine-tuning of the last decoder blocks that teaches a new task prefix",
    "**The pipeline emits no score, probability or quality metric**",
    "**adaptation to a new prefix**",
    "**never seen**",
    "**Lead-1 baseline**",
    "**greedy decoding**",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    1_124_865: "SciTLDR-A dev.jsonl at allenai/scitldr 5ccad9c",
    1_204_107: "SciTLDR-A test.jsonl at allenai/scitldr 5ccad9c",
    3_155_015: "SciTLDR-A train.jsonl at allenai/scitldr 5ccad9c",
    151_037_976: "T5-base fine-tune adapter.safetensors, 4 decoder blocks, from the tutorial run",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "3191fa98ccc09521332b7a1cd63b1930be4e8df125a235ccd31e40329709525e": "SciTLDR-A dev.jsonl at allenai/scitldr 5ccad9c",
    "b222771d387be585cfdf5ae957b36757138415a352e0a3e3b23f73f87c3b1119": "SciTLDR-A train.jsonl at allenai/scitldr 5ccad9c",
    "fb42dd6cd4f4a1928ae8a01a189456fbfe994a07e938bd49f68653933f6503c9": "SciTLDR-A test.jsonl at allenai/scitldr 5ccad9c",
}
